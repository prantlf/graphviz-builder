...
Graph.prototype.to_dot = function() {
  ...
  // Each clusters
  for (id in this.clusters.items) {
    if (Object.prototype.hasOwnProperty.call(this.clusters.items, id)) {
      dotScript = dotScript + this.clusters.items[id].to_dot() + '\n';
    }
  }

  // Each nodes
  for (id in this.nodes.items) {
    if (Object.prototype.hasOwnProperty.call(this.nodes.items, id)) {
  ...
  for (var i in this.edges) {
    if (Object.prototype.hasOwnProperty.call(this.edges, i)) {
